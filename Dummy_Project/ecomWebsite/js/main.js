...
function update_password(){
    jQuery('.field_error').html('');
    var email = jQuery("#password_update_email").val();
	var new_password=jQuery("#new_password").val();
	var confirm_password=jQuery("#confirm_password").val();
	var is_error = '';
    if(email==""){
		jQuery('#password_update_email_error').html('Please enter your email');
        is_error = 'yes';
	}
	if(new_password==""){
